...
export const useSideMenuItems = () => {
  const sideMenuItems = ref([
    ...
    },
    {
      ...
      title: "會計相關-應收帳款明細表",
      parent: "會計相關",
      roleList: ["集團售服的廠端角色","帳號(總管理者)","售服部門主管(總監)","廠端運維管理員","集團(跨廠權限)售服主管","售服主管", "服務廠主管","據點主管", "財務","財務會計"],
    ...
    },
    {
      ...
      title: "經營相關-回廠率查詢",
      parent: "經營相關",
      roleList: ["集團售服的廠端角色","帳號(總管理者)","售服部門主管(總監)","廠端運維管理員","集團(跨廠權限)售服主管","售服主管", "服務廠主管","據點主管"],
    ...
    },
    {
      ...
      title: "零件相關-出貨成本查詢",
      parent: "零件相關",
      roleList: ["集團售服的廠端角色","帳號(總管理者)","售服部門主管(總監)","廠端運維管理員","集團(跨廠權限)售服主管","售服主管", "服務廠主管","據點主管", "零件主管","(零件)主管", "零件人員"],
    ...
    },
    {
      ...
      title: "維修相關-工單維修明細表",
      parent: "維修相關",
      roleList: ["集團售服的廠端角色","帳號(總管理者)","售服部門主管(總監)","廠端運維管理員","集團(跨廠權限)售服主管","售服主管", "服務廠主管","據點主管", "技術主管","(技術)主管"],
